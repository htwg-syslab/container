...
```bash
docker run -d -p 127.0.0.1:40405:22 --hostname=bsyslab --name=bsyslab ghcr.io/htwg-syslab/container/bsyslab:latest
```
...
```bash
docker run -d -p 127.0.0.1:40405:22 --hostname=bsyslab -v bsyslab-home:/home/pocketlab --name=bsyslab ghcr.io/htwg-syslab/container/bsyslab:latest
```
