...
Dann können Sie das Skript ausführen. Hinweise zur Erstellung einer ps1 Datei und dessen Ausführung finden Sie hier: [Anleitung PowerShell Script](./Anleitung_PowerShell_Script)
